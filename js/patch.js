/* ============================================================
   ...
   Layout:

     {
       ...
       engines: { fm, wt, matrix, spectral, micro, granular, op1 }
     }
...
const Patch = (() => {
  ...
  const ENGINES = [
    ...
    {
      key: 'granular',
      get:   () => GranularEngine.getPatch(),
      set:   s  => GranularEngine.loadState(s),
      wake:  () => GranularEngine.init(),
      panic: () => GranularEngine.panic(),
    },
    {
      key: 'op1',
  ...
  function asFactory(preset) {
    ...
    out.engines = {
      ...
      granular: Object.assign(GranularEngine.getPatch(),      { enabled: false }),
